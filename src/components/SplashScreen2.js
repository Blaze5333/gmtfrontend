...
export default function SplashScreen2({navigation,data,scrollX,index,onScroll,id }) {
    const width=Dimensions.get('screen').width
  return (
    <ImageBackground style={{flex:1,width}} source={require('../assets/images/bg2.png')}>
